...
import hoods.com.newsy.features_components.favourite.data.FavouriteRepoImpl
...
object FavouriteModule {
    ...
    @Provides
    @Singleton
    fun provideFavouriteDao(database: NewsyArticleDatabase) = database.favouriteDao()
