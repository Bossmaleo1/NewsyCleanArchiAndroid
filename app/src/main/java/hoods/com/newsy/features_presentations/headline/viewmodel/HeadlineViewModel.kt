...
class HeadlineViewModel @Inject constructor(
    ...
    private fun initHeadlineArticleData() {
        val currentCountryCode = Utils.countryCodeList[headlineState.setting.preferredCountryIndex].code
        val currentLanguageCode = Utils.languageCodeList[headlineState.setting.preferredLanguageIndex].code
